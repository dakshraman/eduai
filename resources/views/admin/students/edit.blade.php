            ...
            <x-ui.card>
                ...
                <x-ui.card-content class="space-y-4">
                    <div class="space-y-2">
                        ...
                        <x-ui.input name="name" value="{{ old('name', $student->name) }}" placeholder="Enter full name" />
                        @error('name') <p class="text-sm text-red-500">{{ $message }}</p> @enderror
                    </div>
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700">Email *</label>
                        <x-ui.input type="email" name="email" value="{{ old('email', $student->email) }}" placeholder="student@email.com" />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui.input name="phone" value="{{ old('phone', $student->phone) }}" placeholder="Phone number" />
                        @error('phone') <p class="text-sm text-red-500">{{ $message }}</p> @enderror
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700">Gender</label>
                            <x-ui.select name="gender" placeholder="Select gender" :options="['male' => 'Male', 'female' => 'Female', 'other' => 'Other']" :value="old('gender', $student->gender)" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700">Date of Birth</label>
                            <x-ui.input type="date" name="dob" value="{{ old('dob', $student->dob) }}" />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <x-ui.select name="blood_group" placeholder="Select" :options="['A+','A-','B+','B-','AB+','AB-','O+','O-']" :value="old('blood_group', $student->blood_group)" />
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700">Religion</label>
                            <x-ui.input name="religion" value="{{ old('religion', $student->religion) }}" placeholder="Religion" />
                        </div>
                    </div>
                    <div class="space-y-2">
            ...
            <x-ui.card>
                ...
                <x-ui.card-content class="space-y-4">
                    <div class="space-y-2">
                        ...
                        <x-ui.select name="class_id" placeholder="Select class" :options="$classes->pluck('name','id')->toArray()" :value="old('class_id', $student->class_id)" />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui.input name="section" value="{{ old('section', $student->section) }}" placeholder="Section" />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui.input name="admission_number" value="{{ old('admission_number', $student->admission_number) }}" placeholder="Admission number" />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui.input name="roll_number" value="{{ old('roll_number', $student->roll_number) }}" placeholder="Roll number" />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui.input type="date" name="admission_date" value="{{ old('admission_date', $student->admission_date?->format('Y-m-d')) }}" />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui.input name="session_year" value="{{ old('session_year', $student->session_year) }}" placeholder="Session year" />
                        @error('session_year') <p class="text-sm text-red-500">{{ $message }}</p> @enderror
                    </div>
                </x-ui.card-content>
                <x-ui.card-footer class="flex justify-end gap-2">
                    <x-ui.button variant="outline" href="{{ route('students.index') }}">Cancel</x-ui.button>
                    <x-ui.button type="submit">Update Student</x-ui.button>
                </x-ui.card-footer>
            </x-ui.card>
        </div>
    </form>
