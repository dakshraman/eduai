...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="{{ route('events.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg transition">
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition">
                ...
                <div class="p-5">
                    <div class="flex items-center gap-2 mb-2">
                        <div class="w-10 h-10 rounded-lg bg-indigo-100 flex flex-col items-center justify-center shrink-0">
                            <span class="text-[10px] font-bold text-indigo-600 leading-none">{{ $event->event_date ? \Carbon\Carbon::parse($event->event_date)->format('M') : '' }}</span>
                            <span class="text-sm font-bold text-indigo-700 leading-none">{{ $event->event_date ? \Carbon\Carbon::parse($event->event_date)->format('d') : '' }}</span>
                        </div>
                        <div>
