...
export default function Index({ structures, payments, summary }) {
    const statCards = [
        ...
        <AppLayout title="My Fees">
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">Your fee structure and payment history</p>
                </div>
                                ...
                                {structures?.length > 0 ? structures.map((s) => (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={6} className="text-center py-8 text-muted-foreground">
                                            No fee structures set for your class.
                                        </TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
